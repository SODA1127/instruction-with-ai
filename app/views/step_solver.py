...
from src.utils import encode_image_to_base64, make_pdf_bytes, parse_thinking_response, _pdf_extract_content, safe_filename
...
def render_step_solver() -> None:
    ...
    if st.button("🧩 단계별 풀이 생성", key="btn_solve", use_container_width=True):
        ...
        system = (("<|think|>\n" if provider == P.LMSTUDIO else "") +
                  get_system_prompt("step_solver", mode))
        ...
        try:
            ...
            st.session_state.step_solver_full_result = result
