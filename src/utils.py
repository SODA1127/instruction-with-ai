    ...
    try:
        ...
        <head>
            ...
            <style>
                ...
                @page {{ margin: 2.5cm; }}
                body {{ 
                    font-family: 'NanumGothic', 'NanumBarunGothic', 'Malgun Gothic', 'Apple SD Gothic Neo', 'Noto Color Emoji', sans-serif;
                    line-height: 1.7;
                    color: #333;
                    font-size: 11pt;
                }}
                ...
                code {{ 
                    ...
                    padding: 2px 5px; 
                    border-radius: 4px; 
                    font-family: "NanumGothicCoding", "SFMono-Regular", Consolas, "Liberation Mono", Menlo, "Noto Color Emoji", monospace;
                    font-size: 0.9em;
                    color: #e11d48;
                }}
                pre {{ 
